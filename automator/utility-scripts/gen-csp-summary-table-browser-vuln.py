...
def main():
    ...
    ROOT_DIR = os.path.join(AUTOMATOR_DIR, os.path.join("%s"%siteId, os.path.join("TestReports", os.path.join("CSP","%s"%bname))))
    OUTPUT_DIR = ROOT_DIR
            ...
            for i in range(len(tempFileLines)):
                ...
                if eachURL in line:
                    ...
                    for j in range(i, 0, -1):
                        ...
                        currentTag = lineHeadingSplitted[2].split("-")[1].strip("\n")
    ...
    with open(OUTPUT_FILE_PATH_NAME, "wb") as outFileFp:
        outFileFp.write("======================================================================\n")
        outFileFp.write("[Subject]: Summary of Results For CSP Attack\n")
    ...
    with open(OUTPUT_FILE_PATH_VULN_NAME, "wb") as outFileFp:
        outFileFp.write("======================================================================\n")
        outFileFp.write("[Subject]: Summary of Vulnerable Results For CSP Attack\n")
        outFileFp.write("[Generated]: %s\n"%timestamp )
        outFileFp.write("======================================================================\n\n\n")
        ...
        for eachKeyURL in resultsDict:
                ...
                for eachCategory in SortedCats:
                        ...
                        for event in diff_cats:
                                ...
                                ev = list(set(eval(event)))
                                if "NO_VIOLATION" in ev and len(ev)>1:
                                    ev.remove("NO_VIOLATION")
                                outFileFp.write("\t\tViolations: {0}\t\tStates: ".format(ev))
